...
def get_azure_recommended_location_by_geography_group(az_geography_group, az_geography_groups_dict):
    for az_geography_group_item in az_geography_groups_dict:
        if az_geography_group == az_geography_group_item:
            return az_geography_groups_dict[az_geography_group][random.randint(0, len(az_geography_groups_dict[az_geography_group])-1)]["name"]
